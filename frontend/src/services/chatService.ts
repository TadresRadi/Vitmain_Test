...
export async function generatePremiumPosts(options?: {
  force_regenerate?: boolean
}): Promise<PremiumPostsResponse> {
...
export async function regenerateSelectedPosts(
  selectedIndexes: number[]
): Promise<RegeneratePostsResponse> {

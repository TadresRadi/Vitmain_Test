    ...
    if (isAuthenticated) {
      ...
      try {
        ...
        if (response.data.action === 'redirect_payment') {
          ...
          navigate(
            `/payment/vodafone-cash?plan=${response.data.plan_slug}&plan_name=${response.data.plan_name}&amount=${response.data.amount}`,
            {
              state: {
          ...
          try {
            ...
            toast({
              ...
              description: t(
                ...
                '10 marketing posts have been tailored to your business profile!'
              ),
            })
          } catch (err: any) {
        ...
        if (redirectAction === 'redirect_chat') {
          ...
          try {
            ...
            if (onboardingRes.data) {
              ...
              navigate('/new-onboarding', {
                state: { autoStartCampaign: shouldAutoStart },
                replace: true,
              })
            }
          } catch {
        ...
        toast({
          ...
          description:
            ...
            t('subscription.failed', 'Failed to activate subscription. Please try again.'),
          variant: 'destructive',
        })
      } finally {
                ...
                >
                  ...
                  <div className="p-8">
                    <div className="text-center mb-8">
                      ...
                      {plan.slug === 'basic' && (
                        <p className="text-sm text-vitamin-base font-semibold mb-4">
                          TESLA L MODLE
                        </p>
                      )}
                      <div className="mb-4">
                        <span className="text-5xl font-bold text-vitamin-base">{plan.price}</span>
                        <span className="text-xl text-white/60 mx-2">
                          {t('pricingPlans.currency')}
                        </span>
                      </div>

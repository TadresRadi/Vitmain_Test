...
export default function Work() {
  ...
  const [storySettings, setStorySettings] = useState({ mode: 'auto', interval: 24, featured_video_id: null as number | null })
  ...
  useEffect(() => {
    ...
    if (storySettings.mode === 'manual' && storySettings.featured_video_id) {
      ...
      const featuredIndex = successStories.findIndex(s => s.id === Number(storySettings.featured_video_id))
      if (featuredIndex !== -1) {

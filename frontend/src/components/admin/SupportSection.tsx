          ...
          {selectedConversation ? (
            <div className="flex-grow flex flex-col h-full overflow-hidden">
              ...
              <div className="flex-grow overflow-y-auto p-6 space-y-4">
                {selectedConversation.messages.map((msg) => {
                  const isAdminSender =
                    msg.sender_email === 'support@vitmain.com' ||
                    msg.sender_name === 'Vitmain Support' ||
                    msg.sender === adminUser?.id
                  ...
                  return (
                    ...
                    >
                      <div className="max-w-[75%] space-y-1">
                        ...
                        <div
                          className={`text-[10px] text-white/30 px-1 ${isAdminSender ? 'text-right' : 'text-left'}`}
                        >
              ...
              <div className="p-4 border-t border-white/5 bg-black/45 backdrop-blur-sm">
                <div className="flex gap-3">
                  <input
                    ...
                    placeholder={t(
                      'adminDashboard.typeReply',
                      'Type supervisor/admin message reply...'
                    )}
            ...
            <div className="h-full flex flex-col items-center justify-center text-center text-white/40 p-6 space-y-3">
              ...
              <p className="text-sm font-medium">
                {t(
                  'adminDashboard.selectRoom',
                  'Select a chat room on the left to start replying.'
                )}
              </p>
            </div>
          )}
